<?php
/**
 * Plugin Name: SEO Agent Bridge 5
 * Description: Lets the SEO Agent (Ascend) read/update Yoast meta, Additional CSS, the Elementor HTML widget, and the _meridian_body field — and, new in v1.4, manage TECHNICAL SEO at the server level: send security response headers and serve /llms.txt, both toggleable via REST and fully reversible. Adds nothing visible to the front end on its own.
 * Version: 1.4.0
