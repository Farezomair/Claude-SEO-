...
_TABLE = {
    ...
    # Trust layer (deterministic; what external auditors grade hardest)
    "fabricated_contact": ("content", "Owner", "needs-human"),
    "fabricated_credential": ("content", "Owner", "needs-human"),
    "schema_selfserving_reviews": ("schema", "SEO Technical", "auto-safe"),
    "schema_fake_address": ("local", "Owner", "needs-human"),
    "no_entity_corroboration": ("local", "Owner", "needs-human"),
    "schema_duplicate_entity": ("schema", "SEO Technical", "needs-approval"),
    "stock_images_hotlinked": ("images", "Owner", "needs-human"),
    "internal_redirect_links": ("site-integrity", "SEO Technical", "needs-approval"),
    "junk_archives": ("indexation", "SEO Technical", "needs-approval"),
