...
AUDIT_CATEGORIES = [
    ...
    {"key": "onpage", "label": "On-page", "weight": 20,
     ...
     "checks": [
         ...
         {"label": "Rendered title matches the intended SEO title", "status": "active"},
         {"label": "No duplicated content blocks within a page", "status": "active"},
    ...
    {"key": "content", "label": "Content & E-E-A-T", "weight": 20,
     ...
     "checks": [
         ...
         {"label": "No cannibalization clusters (several posts, one query)", "status": "active"},
     ]},
...
DOERS = [
    ...
    {"key": "redirects", "agent": "Redirects Agent", "lane": "auto", "status": "active",
     "summary": "broken links → 301 + href hygiene",
